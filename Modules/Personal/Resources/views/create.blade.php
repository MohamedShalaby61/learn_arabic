...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('personals.index') }}">@lang('personal::personal.personals')</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('personal::personal.create_personals')</h3>
                    </div>

                    <form role="form" method="post" action="{{ route('personals.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="name" placeholder="@lang('personal::personal.notes')" class="form-control">
                                </div>
                            </div>
