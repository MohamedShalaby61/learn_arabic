            ...
            <div style="min-height: 800px;" class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 style="font-family: 'Cairo', sans-serif;" class="box-title">{{ 'تخصصات الدروس' }}</h3>
                    </div>


                    <div class="box-body">
                        <div class="form-group">
                            <a href="{{ route('types.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> @lang('type::type.add')</a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('types.destroy',$row->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="{{ route('types.edit',$row->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                                                <button type="submit" onclick="return confirm('هل انت متأكد من حذف النوع')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                        ...
                        @else
                            <h1 style="font-family: 'Cairo', sans-serif;">للاسف لا توجد انواع حتي الان</h1>
                        @endif
                    </div>
                    <!-- /.box-body -->
                </div>
