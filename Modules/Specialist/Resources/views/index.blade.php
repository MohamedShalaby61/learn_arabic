...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>@lang('specialist::specialist.specialists')</li>
        </ol>
    </section>
            ...
            <div style="min-height: 800px;" class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 style="font-family: 'Cairo', sans-serif;" class="box-title">{{ 'التخصص المعلمين' }}</h3>
                    </div>


                    <div class="box-body">
                        <div class="form-group">
                            <a href="{{ route('specialists.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> @lang('specialist::specialist.add')</a>
                        </div>
                        ...
                        @if($rows->count() > 0)
                            <table  id="table_id" class="table table-bordered table-striped table-hover">
                                ...
                                <tr>
                                    <th>#</th>
                                    <th>@lang('specialist::specialist.name')</th>
                                ...
                                @foreach($rows as $index=>$row)
                                    <tr>
                                        ...
                                        <td>{{ $row->name }}</td>
                                        <td>
                                            <form action="{{ route('specialists.destroy',$row->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="{{ route('specialists.edit',$row->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                                                <button specialist="submit" onclick="return confirm('هل انت متأكد من حذف هذا التخصص')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
