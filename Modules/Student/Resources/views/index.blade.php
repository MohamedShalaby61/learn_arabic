...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>@lang('student::student.students')</li>
        </ol>
    </section>
            ...
            <div style="min-height: 800px;" class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 style="font-family: 'Cairo', sans-serif;" class="box-title">{{ 'جدول الطلاب' }}</h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        @if($rows->count() > 0)
                            <table  id="table_id" class="table table-bordered table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>@lang('student::student.email')</th>
                        ...
                        @else
                            <h1 style="font-family: 'Cairo', sans-serif;">للاسف لا توجد طلاب حتي الان</h1>
                        @endif
                    </div>
                    <!-- /.box-body -->
                </div>
