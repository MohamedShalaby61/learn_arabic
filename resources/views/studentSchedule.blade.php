...
@section('css')
    <link href="{{url('/')}}/vendors/fullcalendar/demo/fullcalendar.min.css" rel="stylesheet" type="text/css" />
    <link href="{{url('/')}}/vendors/fullcalendar/demo/fullcalendar.print.min.css" rel="stylesheet" type="text/css"  media='print' />
@endsection
