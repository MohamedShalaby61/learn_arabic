    ...
    <div class="innerpages-top">
		<div>
			<div style="margin: 20px auto auto; max-width: 750px;">
				...
				<div class="page-section bg-white payment-info-card" style="background-color: #fff !important; box-shadow:5px 5px 30px #eee; border: 1px solid yellow;">
					<div>
					...
					<div class="text-center">
						<button class="btn btn-accent" type="button" style="background-color: #d22f32; border-color: #89001a; color:#fff; border: none;" disabled="">@lang('student-subscribe.purchase')</button>
					</div>
				</div>
			</div>
		</div>
