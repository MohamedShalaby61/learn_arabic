...
var now = new Date();
var monthArr = ['يناير', 'فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو', 'يوليو', 'أغسطس', 'سبتمبر', 'أكتوبر', 'نوفمبر', 'ديسمبر'];
//var monthArr = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
var dayArr = ['الأحد', 'الأثنين', 'الثلاثاء', 'الاربعاء', 'الخميس', 'الجمعة', 'السبت'];
...
function resetAll(){
    ...
    function addEvent() {
                ...
                var new_input = "<div id='new_" + new_chq_no + "' class='cart-event'><i onclick='removeEvent()' class='fas fa-trash'></i><label class='lab-cal'>من : </label><label class='lab-cal'>الي : </label><br><i class='fas fa-calendar-alt'></i><input id='inp-from' class='inp-time' type='text' placeholder='0.00 ص'><i class='fas fa-calendar-alt'></i><input class='inp-time' type='text' placeholder='0.00 ص'></div>";
